        ...
        <div>
            <ul className={styles['post-comments']}>
                {comments.map(({ comment, id }) => (
                    <li
                        data-testid="comment-item"   // <- identificador para cada comentário
            ...
            >
                <textarea
                    data-testid="comment-input"   // <- identificador para o campo de texto
                    value={tempComment}
                ...
                />
                <button
                    data-testid="comment-submit"   // <- identificador para o botão
                    type="submit"
